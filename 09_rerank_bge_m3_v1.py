...
# -*- coding: utf-8 -*-
"""
Reranking com BGE-Reranker-v2-m3 (snapshot novo)
"""
...
TEST_FILE = EXP_DIR / "test_pos.jsonl"
MODEL_DIR = EXP_DIR / "models" / "e5_large_ft"
RESULTS_FILE = EXP_DIR / "results_reranked.json"
METRICS_FILE = EXP_DIR / "metrics_reranked.md"
...
def main():
    ...
    md = f"""# Reranking (E5-FT + BGE-Reranker) - Métricas (snapshot novo)
...
"""
    ...
    print("=" * 70)
    print("RERANKING (NOVO) CONCLUÍDO")
    print("=" * 70)
