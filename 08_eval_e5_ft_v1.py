...
# -*- coding: utf-8 -*-
"""
Avaliação E5-Large fine-tuned (snapshot novo)
"""
...
RESULTS_FILE = EXP_DIR / "results_e5_ft.json"
METRICS_FILE = EXP_DIR / "metrics_e5_ft.md"
...
def main():
    ...
    md = f"""# E5-Large Fine-tuned - Métricas (snapshot novo)
...
"""
    ...
    print("=" * 70)
    print("AVALIAÇÃO E5-FT (NOVO) CONCLUÍDA")
    print("=" * 70)
