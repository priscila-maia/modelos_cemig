...
# -*- coding: utf-8 -*-
"""
Baseline E5-Large (sem fine-tune) no snapshot novo
"""
...
RESULTS_FILE = EXP_DIR / "results_baseline_e5.json"
METRICS_FILE = EXP_DIR / "metrics_baseline_e5.md"
...
def main():
    ...
    md = f"""# Baseline E5-Large - Métricas (snapshot novo)
...
"""
    ...
    print("=" * 70)
    print("BASELINE E5-LARGE (NOVO) CONCLUÍDO")
    print("=" * 70)
