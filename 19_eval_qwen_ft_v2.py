...
Mesmo conjunto de teste e mesmas métricas do E5 v2.
"""
...
RESULTS_FILE = EXP_DIR / "results_qwen_ft_v2.json"
METRICS_FILE = EXP_DIR / "metrics_qwen_ft_v2.md"
...
def main():
    ...
    md = f"""# Qwen3-Embedding-0.6B Fine-tuned - Métricas (v2)

**Modelo:** Qwen3-Embedding-0.6B Fine-tuned  
